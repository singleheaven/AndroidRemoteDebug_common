...
public class IMSClientBootstrap {
    ...
    public synchronized void init(OnEventListener imsEventListener, String hosts, int appStatus) {
        if (!isActive()) {
            ...
            imsClient.init(serverUrlList, imsEventListener, new IMSConnectStatusListener());
        }
    }
